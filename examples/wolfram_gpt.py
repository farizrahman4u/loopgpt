...
class AskWolfram(BaseTool):
    ...
    def args(self):
        return {
            "question: str": "The question to ask as a string in natural language."
        }
    
    @property
    def resp(self):
        return {
            "answer: str": "The answer to the question as a string."
        }
...
agent.description = (
    "an AI assistant that can use WolframAlpha. You will be required to calculate the answer to math questions and prepare reports."
)
